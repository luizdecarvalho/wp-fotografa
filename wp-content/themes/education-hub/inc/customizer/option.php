...
// Setting move_logo_after_title.
$wp_customize->add_setting( 'theme_options[move_logo_after_title]',
	array(
	'default'           => $default['move_logo_after_title'],
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'education_hub_sanitize_checkbox',
	)
);
$wp_customize->add_control( 'theme_options[move_logo_after_title]',
	array(
	'label'           => __( 'Move Logo After Title', 'education-hub' ),
	'section'         => 'section_header',
	'type'            => 'checkbox',
	'priority'        => 100,
	'active_callback' => 'education_hub_is_logo_active',
	)
);
// Setting show_title.
